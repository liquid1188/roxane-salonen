...
def main():
    ...
    pil = '<p style="font-size:1rem;color:rgba(244,238,226,.92)">Roxane returns again and again to five wells:</p><p style="font-size:.98rem;color:rgba(238,231,216,.88);line-height:1.65">'
